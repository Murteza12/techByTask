...
open class BubbleTabBar: UITabBar {
    ...
    private func configure() {
        ...
        isTranslucent = false
        barTintColor = #colorLiteral(red: 0.08417870849, green: 0.1840145588, blue: 0.2450139523, alpha: 1)
        
        tintColor = #colorLiteral(red: 0.8938148022, green: 0.5835981965, blue: 0.01152372919, alpha: 1)
    ...
    private func reloadViews() {
        ...
        buttons.forEach { (button) in
            ...
            button.topAnchor.constraint(equalTo: self.container.topAnchor, constant: 12.0).isActive = true
